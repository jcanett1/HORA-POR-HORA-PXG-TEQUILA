...
function Documents({ documents, references, records, user, profile, liveMode, onDocumentsChange }: { documents: MasterDocument[]; references: ReferenceRow[]; records: RecordItem[]; user: User; profile: Profile | null; liveMode: boolean; onDocumentsChange: (documents: MasterDocument[]) => void }) {
