...
export function AuthGate({ children }: { children: (auth: AuthContextValue) => React.ReactNode }) {
  ...
  if (!isSupabaseConfigured) {
    const demoUser = { id: "demo-user", email: "demo@traza.local" } as User;
